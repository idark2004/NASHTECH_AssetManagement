...
const EditUserForm = (props) => {
    ...
    const defaultValues = {
        ...
        gender: user.gender,
        joinDate: moment(user.joinDate).toDate(),
    ...
    const validateDOB = (inputDOB) => {
        ...
        //cal the diff between the cur date vs the DOB (years)
    ...
    const handleEditReq = (input) => {
        const DOBvalidation = validateDOB(input.dateOfBirth);
        const JDvalidation = validateJoinDate(input.joinDate, input.dateOfBirth);
        if (DOBvalidation === false || JDvalidation === false) return;
        AuthService.update(
            defaultValues.id,
                    ...
                    >
                        ...
                        <Form.Field inline>
                            ...
                            >
                                <option
                                    value="2"
                                    selected={defaultValues.roleId === "2"}
                                >Staff</option>
                                <option
                                    value="1"
                                    selected={defaultValues.roleId === "1"}
                                >Admin</option>
                            </select>
                        </Form.Field>
                        <Button type="submit" color="red" button disabled={dob === null || joinDate === null}>
                            Save
                        </Button>
